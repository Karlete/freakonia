...
var NEWS_DATA = [
  ...
  // ── NOTICIA 73 — FREAKOCHAPA #3 ─────────────────────────────────────────────
  {
    ...
    title: 'PS1: por qué su biblioteca sigue siendo la mejor de la historia',
    summary: 'Verano del 97, el Eroski de toda la vida y una PlayStation de regalo sin tarjeta de memoria. Así empezó todo. Repaso los 14 juegos de PS1 a los que jugué en su momento y que siguen mereciendo tu tiempo hoy mismo. Con puntuaciones Freakcoin incluidas.',
    full: [
      'Todas aprobadas. Verano del 97, centro comercial Ruta de la Plata, el Eroski de toda la vida, y tus padres te compran la PS1. Sin tarjeta de memoria —no sabíamos aún ni que existían—, un CD de demos y de regalo el Loaded versión Platinum, que era la línea económica que sacaba Sony para que los juegos te salieran más baratos. Imagínate el percal de jugar al Loaded o a cualquier cosa que nos alquilábamos entonces, sin poder guardar la partida. Luego cayeron la tarjeta de memoria y otro mando. Y poco después fuimos bendecidos con el FFVII, que ya tiene aquí su propio reportaje.',
      '<img src="assets/img/PS1/metalgear.jpg" alt="Metal Gear Solid PS1" style="width:100%;max-width:300px;border:4px solid #ffcc00;display:block;margin:0.75rem 0;image-rendering:pixelated;"><strong>1. Metal Gear Solid</strong> — Una barrabasada adelantada a su época. Era como vivir una película: mezcla de acción, sigilo, cinemáticas increíbles y el mejor doblaje al español que jamás ha tenido un videojuego. ¡Snake! ¡Snaaaaaake! <span style="display:inline-block;font-family:\'Press Start 2P\',monospace;font-size:8px;color:#ffcc00;border:2px solid #ffcc00;padding:3px 7px;margin-left:6px;vertical-align:middle;">▣ 10 / 10 FREAKCOINS</span>',
      '<img src="assets/img/PS1/FFVII.jpg" alt="Final Fantasy VII IX PS1" style="width:100%;max-width:300px;border:4px solid #ffcc00;display:block;margin:0.75rem 0;image-rendering:pixelated;"><strong>2. Final Fantasy VII / IX</strong> — El primer JRPG que llegó a Europa, y pegó fuerte, muy fuerte. Banda sonora maravillosa, historia larga y emocionante —a pesar de la traducción que traía—, combate por turnos, fondos prerenderizados, invocaciones, materias, magias y un villano terrible. Lo tiene todo. Incluyo también al FFIX: son imprescindibles los dos. <span style="display:inline-block;font-family:\'Press Start 2P\',monospace;font-size:8px;color:#ffcc00;border:2px solid #ffcc00;padding:3px 7px;margin-left:6px;vertical-align:middle;">▣ 10 / 10 FREAKCOINS</span>',
      '<img src="assets/img/PS1/castlevania.jpg" alt="Castlevania Symphony of the Night PS1" style="width:100%;max-width:300px;border:4px solid #ffcc00;display:block;margin:0.75rem 0;image-rendering:pixelated;"><strong>3. Castlevania: Symphony of the Night</strong> — Un juegarral como la copa de un pino. Un solo mapa —el castillo de Drácula—, pero enorme y lleno de miles de sorpresas. Un metroidvania fabuloso con toques de rol, miles de armas y objetos, y una estética que sigue siendo preciosa a día de hoy. <span style="display:inline-block;font-family:\'Press Start 2P\',monospace;font-size:8px;color:#ffcc00;border:2px solid #ffcc00;padding:3px 7px;margin-left:6px;vertical-align:middle;">▣ 10 / 10 FREAKCOINS</span>',
      '<img src="assets/img/PS1/abe.jpg" alt="Oddworld Abe Oddysee PS1" style="width:100%;max-width:300px;border:4px solid #00ff41;display:block;margin:0.75rem 0;image-rendering:pixelated;"><strong>4. Oddworld: Abe\'s Oddysee</strong> — El del marcianito que tiene que rescatar a sus congéneres de la tiranía de los malvados que los explotan en fábricas. Podías controlar mentalmente a los enemigos; era como una especie de Príncipe de Persia moderno. Buenísimo. <span style="display:inline-block;font-family:\'Press Start 2P\',monospace;font-size:8px;color:#00ff41;border:2px solid #00ff41;padding:3px 7px;margin-left:6px;vertical-align:middle;">▣ 7 / 10 FREAKCOINS</span>',
      '<img src="assets/img/PS1/alundra.jpg" alt="Alundra PS1" style="width:100%;max-width:300px;border:4px solid #cc44ff;display:block;margin:0.75rem 0;image-rendering:pixelated;"><strong>5. Alundra</strong> — El Zelda de la PlayStation. Maravillosamente difícil, puzles complejos, una jugabilidad superchula y un mapa precioso. El juego es largo y complicado, pero muy agradecido. Es de esos tesoros ocultos que merecen mucho más reconocimiento. <span style="display:inline-block;font-family:\'Press Start 2P\',monospace;font-size:8px;color:#cc44ff;border:2px solid #cc44ff;padding:3px 7px;margin-left:6px;vertical-align:middle;">▣ 8 / 10 FREAKCOINS</span>',
      '<img src="assets/img/PS1/grantheftauto.jpg" alt="Grand Theft Auto PS1" style="width:100%;max-width:300px;border:4px solid #00ff41;display:block;margin:0.75rem 0;image-rendering:pixelated;"><strong>6. Grand Theft Auto</strong> — El precursor, los orígenes, el que lo empezó todo. Con esa vista desde arriba tan complicada para conducir y moverte por la ciudad. Cuántos recuerdos yendo a las cabinas de teléfono a recoger misiones y usando los Kill Frenzy a saco. ¡Tremendo! <span style="display:inline-block;font-family:\'Press Start 2P\',monospace;font-size:8px;color:#00ff41;border:2px solid #00ff41;padding:3px 7px;margin-left:6px;vertical-align:middle;">▣ 6 / 10 FREAKCOINS</span>',
      '<img src="assets/img/news/gaming_generic.webp" alt="Gran Turismo PS1" style="width:100%;max-width:300px;border:4px solid #cc44ff;display:block;margin:0.75rem 0;image-rendering:pixelated;"><strong>7. Gran Turismo</strong> — Yo no soy de juegos de coches, pero este es maravilloso. Tienes que sacarte el carné y todo. Todo tipo de modos de juego, competiciones y un catálogo enorme de coches. ¡Sensacional! <span style="display:inline-block;font-family:\'Press Start 2P\',monospace;font-size:8px;color:#cc44ff;border:2px solid #cc44ff;padding:3px 7px;margin-left:6px;vertical-align:middle;">▣ 8 / 10 FREAKCOINS</span>',
      '<img src="assets/img/news/gaming_generic.webp" alt="Legacy of Kain Soul Reaver PS1" style="width:100%;max-width:300px;border:4px solid #00ff41;display:block;margin:0.75rem 0;image-rendering:pixelated;"><strong>8. Legacy of Kain: Soul Reaver</strong> — Una aventura dentro de Nosgoth y sus nueve Pilares, donde cada pilar está representado por un guardián. Qué precioso era el protagonista Raziel, ese vampiro convertido en espectro con un destino trágico. Muy entretenido. <span style="display:inline-block;font-family:\'Press Start 2P\',monospace;font-size:8px;color:#00ff41;border:2px solid #00ff41;padding:3px 7px;margin-left:6px;vertical-align:middle;">▣ 7 / 10 FREAKCOINS</span>',
      '<img src="assets/img/PS1/residentevil.jpg" alt="Resident Evil 2 PS1" style="width:100%;max-width:300px;border:4px solid #cc44ff;display:block;margin:0.75rem 0;image-rendering:pixelated;"><strong>9. Resident Evil 2</strong> — El no va más. ¿Quién no recuerda a esos policías enfrentándose a los zombis en Raccoon City? Qué duro era ese primer monstruo en el pasillo, y lo complicado que se iba volviendo el juego. Muchísimo miedo y muchísima acción. <span style="display:inline-block;font-family:\'Press Start 2P\',monospace;font-size:8px;color:#cc44ff;border:2px solid #cc44ff;padding:3px 7px;margin-left:6px;vertical-align:middle;">▣ 9 / 10 FREAKCOINS</span>',
      '<img src="assets/img/PS1/silenthill.jpg" alt="Silent Hill PS1" style="width:100%;max-width:300px;border:4px solid #cc44ff;display:block;margin:0.75rem 0;image-rendering:pixelated;"><strong>10. Silent Hill</strong> — Más miedo todavía. La niebla constante, los perros rabiosos, la linterna, el sonido de la alarma, el mapa. Un clásico entre los clásicos. Hoy los controles son torpes y ortopédicos, pero sigue siendo un juegarral. <span style="display:inline-block;font-family:\'Press Start 2P\',monospace;font-size:8px;color:#cc44ff;border:2px solid #cc44ff;padding:3px 7px;margin-left:6px;vertical-align:middle;">▣ 8 / 10 FREAKCOINS</span>',
      '<img src="assets/img/PS1/tekken3.jpg" alt="Tekken 3 PS1" style="width:100%;max-width:300px;border:4px solid #ffcc00;display:block;margin:0.75rem 0;image-rendering:pixelated;"><strong>11. Tekken 3</strong> — El juego de peleas por excelencia. A día de hoy sigue siendo mejor que muchos Tekkens más modernos. Me sé aún combos de memoria de un montón de luchadores. ¡El mejor Tekken! <span style="display:inline-block;font-family:\'Press Start 2P\',monospace;font-size:8px;color:#ffcc00;border:2px solid #ffcc00;padding:3px 7px;margin-left:6px;vertical-align:middle;">▣ 10 / 10 FREAKCOINS</span>',
      '<img src="assets/img/PS1/tombraider.jpg" alt="Tomb Raider PS1" style="width:100%;max-width:300px;border:4px solid #00ff41;display:block;margin:0.75rem 0;image-rendering:pixelated;"><strong>12. Tomb Raider</strong> — Maravilloso y espectacular. Aventuras con Lara en la búsqueda de llaves, ruedas de motor o lo que hiciera falta. Inolvidable la aparición del T-Rex en uno de los niveles principales. <span style="display:inline-block;font-family:\'Press Start 2P\',monospace;font-size:8px;color:#00ff41;border:2px solid #00ff41;padding:3px 7px;margin-left:6px;vertical-align:middle;">▣ 7 / 10 FREAKCOINS</span>',
      '<img src="assets/img/PS1/tenchu.jpg" alt="Tenchu Stealth Assassins PS1" style="width:100%;max-width:300px;border:4px solid #ffcc00;display:block;margin:0.75rem 0;image-rendering:pixelated;"><strong>13. Tenchu: Stealth Assassins</strong> — El mejor juego de ninjas jamás hecho. A pesar de ser tosco a día de hoy y tener unos gráficos lamentables, tiene una banda sonora apoteósica. Completar los niveles a sigilo total es un auténtico reto. ¡JUEGACO! <span style="display:inline-block;font-family:\'Press Start 2P\',monospace;font-size:8px;color:#ffcc00;border:2px solid #ffcc00;padding:3px 7px;margin-left:6px;vertical-align:middle;">▣ 10 / 10 FREAKCOINS</span>',
      '<img src="assets/img/PS1/tony.jpg" alt="Tony Hawk Pro Skater PS1" style="width:100%;max-width:300px;border:4px solid #00bfff;display:block;margin:0.75rem 0;image-rendering:pixelated;"><strong>14. Tony Hawk\'s Pro Skater</strong> — Qué desfase pillarte a los skaters de moda del momento y ponerte a rodar a saco por las pistas. Inolvidable. <span style="display:inline-block;font-family:\'Press Start 2P\',monospace;font-size:8px;color:#00bfff;border:2px solid #00bfff;padding:3px 7px;margin-left:6px;vertical-align:middle;">▣ 5 / 10 FREAKCOINS</span>',
      'Y seguro que me dejo muchos más, pero con esta pedazo de lista da para mucho, como la trucha al trucho. El catálogo de PS1 sigue siendo, a día de hoy, una barbaridad.'
    ],
    date: '24/04/2026',
    url: 'gaming.html',
    page: 'gaming.html',
    ...
    img: 'assets/img/PS1/metalgear.jpg',
    tags: ['PS1', 'PlayStation', 'retro gaming', 'Metal Gear Solid', 'Final Fantasy VII', 'Tekken 3', 'Resident Evil 2', 'Freakochapa']
  },
  ...
  // ── NOTICIA 53 — FREAKOCHAPA #2 ─────────────────────────────────────────────
  {
    ...
    emoji: '🕹',
    badgeLabel: 'FREAKOCHAPA',
    title: 'Master System II: 10 juegarrales que definen una consola inolvidable',
    summary: 'La Master System II nos llegó como regalo y primera consola en casa. Sin cartuchos ni nada, ya traía el Alex Kidd en la memoria. Esta es mi lista personal de los 10 juegarrales que realmente viví en cartucho. Sin orden, sin pretensiones. Solo nostalgia y mucha verdad.',
    full: [
      'La maravillosa Master System II nos cayó como regalo y primera consola en casa, allá por los principios de los años 90. No teníamos ningún juego de primeras, pero la magia de esta consola residía en que incluso sin cartucho, al encenderla, aparecía el Alex Kidd, que venía directamente en la memoria de la consola. Hago esta lista personal porque son los mejores juegos a los que jugué realmente y en cartucho. Sin orden, son solo 10 juegarrales.',
      '<img src="assets/img/mastersystem2/alexkidd.webp" alt="Alex Kidd Master System II" style="width:100%;max-width:300px;border:4px solid #ff3131;display:block;margin:0.75rem 0;image-rendering:pixelated;"><strong>1. Alex Kidd</strong> — Complicado, de estética muy infantiloide, pero adorable juego 2D de plataformas en el que manejamos a Alex en busca de la princesa secuestrada. Sorprendía su dificultad alta a pesar de parecer tan infantil, requería de mucha habilidad. Me acuerdo todavía de los duelos contra los bosses finales que eran al mejor de 3 jugando al piedra, papel o tijera. Lo malo es que nunca llegué a pasármelo del todo, obligaba a mucha precisión para la época. ¡Ja, si lloritos! <span style="display:inline-block;font-family:\'Press Start 2P\',monospace;font-size:8px;color:#ff3131;border:2px solid #ff3131;padding:3px 7px;margin-left:6px;vertical-align:middle;">▣ 4 / 10 FREAKCOINS</span>',
      '<img src="assets/img/mastersystem2/asterix.webp" alt="Asterix Master System II" style="width:100%;max-width:300px;border:4px solid #00ff41;display:block;margin:0.75rem 0;image-rendering:pixelated;"><strong>2. Asterix</strong> — Me molaba muchísimo, era alquilado siempre como una opción sólida en el videoclub. Me gustaba mucho el rollo de jugar pantallas con Asterix y luego poder cambiar a Obelix. Estética chula, buena música y recordatorio sublime de los cómics de Asterix que tanto me leía en esa época. <span style="display:inline-block;font-family:\'Press Start 2P\',monospace;font-size:8px;color:#00ff41;border:2px solid #00ff41;padding:3px 7px;margin-left:6px;vertical-align:middle;">▣ 6 / 10 FREAKCOINS</span>',
      '<img src="assets/img/mastersystem2/castle_of_ilusion.webp" alt="Castle of Illusion Master System II" style="width:100%;max-width:300px;border:4px solid #00bfff;display:block;margin:0.75rem 0;image-rendering:pixelated;"><strong>3. Castle of Illusion</strong> — Del queridísimo Mickey Mouse, otro plataformas del estilo de los anteriores, pero que te pilla a una edad en la que se convierte enseguida en tu juego favorito. Fácil y cómodo de jugar, lo recuerdo con mucho cariño, aunque le han pasado mal los años. ¿Y a cuál no? Aun así, más que respetable juego de la MSII. <span style="display:inline-block;font-family:\'Press Start 2P\',monospace;font-size:8px;color:#00bfff;border:2px solid #00bfff;padding:3px 7px;margin-left:6px;vertical-align:middle;">▣ 5 / 10 FREAKCOINS</span>',
      '<img src="assets/img/mastersystem2/ghoulsandghosts.webp" alt="Ghouls n Ghosts Master System II" style="width:100%;max-width:300px;border:4px solid #ffcc00;display:block;margin:0.75rem 0;image-rendering:pixelated;"><strong>4. Ghouls\'n Ghosts</strong> — La joya de la corona. Regalo de cumpleaños completo, no quería otra cosa. Fue alquilarlo y caer enamorado, antes primero alquilábamos y luego comprábamos. Lo tiene todo: estética, música, jugabilidad, dificultad, temática atrayente. De los mejores juegos que hay en todas sus versiones. Simplemente magnífico. <span style="display:inline-block;font-family:\'Press Start 2P\',monospace;font-size:8px;color:#ffcc00;border:2px solid #ffcc00;padding:3px 7px;margin-left:6px;vertical-align:middle;">▣ 10 / 10 FREAKCOINS</span>',
      '<img src="assets/img/mastersystem2/princeofpersia.webp" alt="Prince of Persia Master System II" style="width:100%;max-width:300px;border:4px solid #cc44ff;display:block;margin:0.75rem 0;image-rendering:pixelated;"><strong>5. Prince of Persia</strong> — El juego de los juegos. Su producción con cámara grabando al protagonista con sus saltos, movimientos y carreras. El juego por excelencia, todo un clásico imprescindible. Te cautiva desde el principio. Siempre mola volver a jugarlo. <span style="display:inline-block;font-family:\'Press Start 2P\',monospace;font-size:8px;color:#cc44ff;border:2px solid #cc44ff;padding:3px 7px;margin-left:6px;vertical-align:middle;">▣ 8 / 10 FREAKCOINS</span>',
      '<img src="assets/img/mastersystem2/shadowofthebeast.webp" alt="Shadow of the Beast Master System II" style="width:100%;max-width:300px;border:4px solid #cc44ff;display:block;margin:0.75rem 0;image-rendering:pixelated;"><strong>6. Shadow of the Beast</strong> — Es de esos juegos raros que conoces por casualidad o porque alguien te ha hablado de él. Es dificilísimo, por lo menos en la Master System, pero tiene una estética y una banda sonora súper potentes. A mí personalmente me flipa, y no es muy conocido, o eso creo. Te atrapa. <span style="display:inline-block;font-family:\'Press Start 2P\',monospace;font-size:8px;color:#cc44ff;border:2px solid #cc44ff;padding:3px 7px;margin-left:6px;vertical-align:middle;">▣ 8 / 10 FREAKCOINS</span>',
      '<img src="assets/img/mastersystem2/shinobi.webp" alt="Shinobi Master System II" style="width:100%;max-width:300px;border:4px solid #00ff41;display:block;margin:0.75rem 0;image-rendering:pixelated;"><strong>7. Shinobi</strong> — Con lo que nos gustan los ninjas aquí, ¿cómo no nos va a gustar el padre del Tenchu? Este juego es buenísimo, entretiene y es de enganche fácil. Luego encima tiene versiones también muy guapas como el Shadow Dancer y posteriores. Qué buen juego el Shinobi. <span style="display:inline-block;font-family:\'Press Start 2P\',monospace;font-size:8px;color:#00ff41;border:2px solid #00ff41;padding:3px 7px;margin-left:6px;vertical-align:middle;">▣ 7 / 10 FREAKCOINS</span>',
      '<img src="assets/img/mastersystem2/sonic.webp" alt="Sonic Master System II" style="width:100%;max-width:300px;border:4px solid #cc44ff;display:block;margin:0.75rem 0;image-rendering:pixelated;"><strong>8. Sonic</strong> — Había compis que tenían el Mario en la NES, nosotros el Sonic en la Master System. Adrenalina pura, un pasote de juego, velocidad y dopamina a tope para la época. Juegarraco donde los haya. Joder, qué de vicios al Sonic. Si me acuerdo hasta del nombre del malo, el doctor Robotnik. <span style="display:inline-block;font-family:\'Press Start 2P\',monospace;font-size:8px;color:#cc44ff;border:2px solid #cc44ff;padding:3px 7px;margin-left:6px;vertical-align:middle;">▣ 9 / 10 FREAKCOINS</span>',
      '<img src="assets/img/mastersystem2/streetofrage.webp" alt="Streets of Rage Master System II" style="width:100%;max-width:300px;border:4px solid #ffcc00;display:block;margin:0.75rem 0;image-rendering:pixelated;"><strong>9. Streets of Rage</strong> — Peleas sucias y chungas, a repartir hostias como panes desde el principio. Banda sonora increíble del señor Yuzo Koshiro, incluso hoy en 2026 suenan brutales. Hizo también la del Revenge of Shinobi. Juego imprescindible. ¡JUEGARRAL! <span style="display:inline-block;font-family:\'Press Start 2P\',monospace;font-size:8px;color:#ffcc00;border:2px solid #ffcc00;padding:3px 7px;margin-left:6px;vertical-align:middle;">▣ 10 / 10 FREAKCOINS</span>',
      '<img src="assets/img/mastersystem2/supermonaco.webp" alt="Super Monaco GP Master System II" style="width:100%;max-width:300px;border:4px solid #ff3131;display:block;margin:0.75rem 0;image-rendering:pixelated;"><strong>10. Super Monaco GP</strong> — Nos lo regaló un vecino y todavía solo teníamos un juego, así que era el que tenías de alternativa cuando quemabas el otro. Solo por eso tiene un huequito en el reino. Aunque el juego era jodido, no era entonces muy fan de los de coches, pero bueno, ahí estaba. <span style="display:inline-block;font-family:\'Press Start 2P\',monospace;font-size:8px;color:#ff3131;border:2px solid #ff3131;padding:3px 7px;margin-left:6px;vertical-align:middle;">▣ 4 / 10 FREAKCOINS</span>'
    ],
    date: '21/04/2026',
    url: 'gaming.html',
    page: 'gaming.html',
    ...
    accent: '#00bfff',
    source: 'freakonia.com',
    img: 'assets/img/mastersystem2/ghoulsandghosts.webp',
    tags: ['Master System II', 'retro gaming', 'Alex Kidd', 'Sonic', 'Streets of Rage', 'Ghouls n Ghosts', 'nostalgia', 'MSII', '90s']
  },
